...
describe("it should manipulates the interface", () => {
  it("it should remove pokemon cards", () => {
    ...
    removePokemons();
    expect(document.querySelector("body")).not.toContainEqual(
  ...
  it("it should hidden and show parts of interface", () => {
    ...
    `;
    handleInterface();
    expect(document.querySelector(".main-screen").className).toContain(
      "hidden"
    );
    expect(document.querySelector("header").className).not.toContain("hidden");
    expect(document.querySelector("#results").className).not.toContain(
      "hidden"
    );
